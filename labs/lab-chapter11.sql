...
BEGIN --{
  RETURN
	...
	-- subtract 1 if you have not had your birthday
...
select dbo.GetAge('19500118', '20200417');
select dbo.GetAge('19940624', '20200417');
